...
class MagicCreateRequestCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'magic:createRequest';
     ...
     * @deprecated
     */
    protected static $defaultName = 'magic:createRequest';
    ...
    protected function buildClass($name)
    {
        if ($this->alreadyExists(str_replace('.php', '', $this->getPath($name)))) {
            $this->components->error("This CreateRequest already exists");
            return;
        }
    ...
    {
        return __DIR__.'/stubs/createRequest.stub';
    }
