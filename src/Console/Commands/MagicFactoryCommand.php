...
class MagicFactoryCommand extends GeneratorCommand
{
     ...
     * @deprecated
     */
    protected static $defaultName = 'magic:factory';
     ...
     * @var string
     */
    protected $description = 'Create a new magic factory class';
    ...
    protected function buildClass($name)
    {
        if ($this->alreadyExists(str_replace('.php', '', $this->getPath($name)))) {
            $this->components->error("This Factory already exists");
            return;
        }
