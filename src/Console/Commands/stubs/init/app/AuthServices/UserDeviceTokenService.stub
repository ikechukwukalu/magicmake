...
class UserDeviceTokenService extends BasicCrudService
{
     ...
     *
     * @param  \App\Http\Requests\Auth\UserDeviceTokenCreateRequest $request
     ...
     *
     * @param  \App\Http\Requests\Auth\UserDeviceTokenUpdateRequest $request
     * @return \App\Actions\ResponseData
     */
     ...
     *
     * @param  \App\Http\Requests\Auth\UserDeviceTokenDeleteRequest $request
     * @return \App\Actions\ResponseData
     */
