...
class VerificationController extends Controller
{
     ...
     * @group No Auth APIs
     */
    public function verifyUserPhone(Request $request): JsonResponse
    {
        return $this->verificationService->handleVerifyUserPhone($request);
    }

    /**
     * User resend phone verification.
     *
     * This endpoint is used to generate and send via phone a URL for User phone verification to a registered User.
     *
     * @header Authorization Bearer {Your key}
     *
     * @queryParam id string required <small class="badge badge-blue">id</small> Field must belong to a registered User. Example: 1
     ...
     * @group Auth APIs
     */
    public function resendUserPhoneVerification(Request $reques): JsonResponse
    {
        return $this->verificationService->resendUserPhoneVerification();
    }
}
